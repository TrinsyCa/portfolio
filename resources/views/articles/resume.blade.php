        ...
        <section class="timeline">
          ...
          <ol class="timeline-list">
            ...
            <li class="timeline-item">
              ...
              <h4 class="h4 timeline-item-title">Borsa Istanbul Technical and Anatolian High School</h4>
        ...
        <section class="timeline">
          ...
          <ol class="timeline-list">
            <li class="timeline-item">
              ...
              <h4 class="h4 timeline-item-title">Co-Founder & Web Developer</h4>

              <span>2024 - Present</span>

              <p class="timeline-text">
                Cool Travel Istanbul LLC
              </p>
            ...
            <li class="timeline-item">
              ...
              <p class="timeline-text">
                KLE Information Technologies Inc.
              </p>
